...
template void LaunchBottomScanKernel<float,float4,BLOCK_SIZE>( int, int, int, float*, float*, float*, int );
template void LaunchBottomScanKernel<double,double4,BLOCK_SIZE>( int, int, int, double*, double*, double*, int );
