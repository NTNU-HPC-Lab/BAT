...
class KernelTuner:
    ...
    def tune(self, gpu_name, strategy="mls", strategy_options=None, verbose=True, quiet=False, simulation_mode=False):
        ...
        iterations = eval(str(self.manager.spec["benchmarkConfig"]["iterations"]))    # number of times each kernel configuration is ran
