...
class ScanTuner(MeasurementInterface):
    ...
    def manipulator(self):
        ...
        manipulator.add_parameter(EnumParameter('BLOCK_SIZE', [252, 252]))
        #manipulator.add_parameter(IntegerParameter('BLOCK_SIZE', 252, 252))
    ...
    def run(self, desired_result, input, limit):
        ...
        make_program = f'nvcc -gencode=arch=compute_{cc},code=sm_{cc} -I {start_path}/cuda-common -I {start_path}/common -g -O2 -c {start_path}/scan/scan.cu'
