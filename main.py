...
def add_standard_arguments_to_parser(parser):
    ...
    parser.add_argument('--search-path', type=str, default="search-settings.json", help='Path to T1-compliant JSON')
    ...
    parser.add_argument('--logging', type=bool, default=False, help='Verbosity level for tuner output')
    return parser
