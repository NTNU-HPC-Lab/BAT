...
def add_standard_arguments_to_parser(parser):
    parser.add_argument('--tuner', type=str, default=["mintuner"], nargs='+', help='Which tuners to use')
    parser.add_argument('--benchmarks', type=str, default=["GEMM"], nargs='+', help='Name of T1-compliant JSON')
